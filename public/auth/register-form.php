...
<body class="bg-slate-100 p-6 font-manrope">
    <main class="grid lg:grid-cols-2 gap-12 items-center w-full max-w-6xl mx-auto min-h-screen">
        ...
        <section class="relative">
            ...
            <form
                ...
                <div class="mb-8">
                    <h2 class="font-bold text-3xl">Sukurkite paskyrą</h2>
                    <p class="text-gray-600">Sekite savo išlaidas ir geriau valdykite finansus</p>
                </div>
